...
\(s_x, s_y\) are bbox half-spans; with `FALSE`, independent scales are used per axis. Uniform scaling preserves circular symmetry of the focus and glue; per-axis scaling yields an ellipticalinterpretation that can be usefulcommon for long, narrow extents but should be used deliberately. Degenerate
...
The github repo for this paper is [https://github.com/Alex-Nguyen-VN/paper-mapycusmaximus](https://github.com/Alex-Nguyen-VN/paper-mapycusmaximus).

The mapycusmaximus package is available at [https://github.com/Alex-Nguyen-VN/mapycusmaximus](https://github.com/Alex-Nguyen-VN/mapycusmaximus).
