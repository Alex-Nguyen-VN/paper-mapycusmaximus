...
Data provenance. The France grid example uses `france_sport.gpkg` from B. Nowak’s repository (github.com/BjnNowak/lego_map), where `value` denotes the percentage of population who are members of a sport association. We classify `value` into six bins for a gridded choropleth and overlay centroids for reference.
