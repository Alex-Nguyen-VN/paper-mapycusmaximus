...
```{r transformation-table, echo=FALSE, caption = "Coordinate transformation across fisheye zones for selected points on a regular grid"}
...
For multi-layer maps, the normal process is combine all the layers into a single sf object and apply `sf_fisheye()`, then split the result later. One minialist example for this approach is show in the code block \@ref{tab:multi-layer-example}.
