...
This process is shown in Figure \ref{fig:plot-fgc}. Although it is hard to tell from the figure, here the polygons are continuous, and boundaries are preserved. This means that features such as shading polygons will work as expected.
