...
For multi-layer maps, the normal process is combine all the layers into a single sf object and apply \texttt{sf\_fisheye()}, then split the result later. One minialist example for this approach is show in the code block @ref\{lst:multi-layer-example\}.
