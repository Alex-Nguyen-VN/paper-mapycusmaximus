...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{paper-mapycusmaximus_files/figure-latex/radii-prepare-1.pdf}}
\caption{\label{fig:radii-prepare}Map scale for different radii}
\end{figure}
